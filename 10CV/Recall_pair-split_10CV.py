...
if  "__main__" == __name__:
    ...
    random_states = [20200914, 20200915,20200916,20200917,20200918, 20200919,20200920,20200921, 20200922]
    for random_state in random_states: 
        middle_res = pd.DataFrame()
        res = pd.DataFrame()
        
        for i in range(1,10):
            relation_0 = pd.read_csv(r"E:\student\ysq\PCM\Nova\proba\test\10CV\{}_10fold.csv".format(random_state))
...
#            num = 1000 
        ...
        #        methods = ['X1', 'X2','X3','X4','X5','X6', 'average','maxism','stacked']
                ...
                res.to_csv(r"E:\student\ysq\PCM\Nova\proba\test\recall\watch_recall_test.csv",index=False)
                
#            middle_res.to_csv(r"E:\student\ysq\PCM\Nova\proba\test\recall\{}_recall_test.gzip".format(random_state),index=False)
#            res.to_csv(r"E:\student\ysq\PCM\Nova\proba\test\recall\{}_recall_test.csv".format(random_state),index=False)
